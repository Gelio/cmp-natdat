...
describe("Time24H", function()
	describe("format_iso", function()
		it("uses full numbers when hours and minutes are passed", function()
			assert.equals("9:12", natdat_time.Time24H.new(9, 12):format_iso())
		end)

		it("uses 00 for minutes when not specified", function()
			assert.equals("14:00", natdat_time.Time24H.new(14, nil):format_iso())
		end)

		it("pads minutes to two zeros", function()
			assert.equals("14:01", natdat_time.Time24H.new(14, 1):format_iso())
		end)
	end)
end)
...
describe("TimeAMPM", function()
	describe("format_original", function()
		it("uses full numbers when hours and minutes are passed", function()
			assert.equals("9:12am", natdat_time.TimeAMPM.new(9, 12, "am"):format_original())
		end)

		it("skips minutes when not specified", function()
			assert.equals("12pm", natdat_time.TimeAMPM.new(12, nil, "pm"):format_original())
		end)

		it("pads minutes to two zeros", function()
			assert.equals("12:01pm", natdat_time.TimeAMPM.new(12, 1, "pm"):format_original())
		end)
	end)
